 ...
 * They test with REAL DATABASE connections (PostgreSQL and optionally MongoDB).
 *
 * Prerequisites:
...
describe('Voyage Service Health Endpoints - Integration Tests with Real DB (INFRA-013.1)', () => {
  describe('GET /health', () => {
