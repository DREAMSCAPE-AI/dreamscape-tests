...
module.exports = {
  ...
  roots: [
    '<rootDir>/dreamscape-tests/tests/US-TEST-016-recommendation-service',
    '<rootDir>/dreamscape-services/ai/src/services',
  ],
  testMatch: ['**/US-TEST-016-recommendation-service/**/*.test.ts'],
  ...
  collectCoverageFrom: [
    '<rootDir>/dreamscape-services/ai/src/services/RecommendationService.ts',
  ],
  coverageDirectory: '<rootDir>/dreamscape-tests/coverage/test016',
  coverageThreshold: {
